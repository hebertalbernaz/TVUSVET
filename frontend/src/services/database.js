 ...
 * Atualizado para suportar "originalData" nas imagens
 */
...
class DatabaseService {
 ...
 // 🔴 CORREÇÃO: Agora salva o mimeType (importante para DICOM)
  ...
  // ... (Templates, Refs, Settings, Backup iguais ao anterior) ...
  async initializeDefaultTemplates() {
    const templates = [
      ...
      { id: this.genId(), organ: 'Impressões Diagnósticas', lang: 'pt', title: 'Sugestão', text: 'Achados compatíveis com...' },
      { id: this.genId(), organ: 'Impressões Diagnósticas', lang: 'en', title: 'Suggestion', text: 'Findings compatible with...' }
    ];
